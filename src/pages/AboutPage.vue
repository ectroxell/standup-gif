  ...
  <q-page class="flex items-center column q-mb-lg q-px-md">
    <div class="flex items-left column q-mb-sm q-mt-lg about-content">
      ...
      <p class="text-body1">
        ...
        <strong>five years of experience</strong> building custom web applications that solve real
        problems for both customers and internal teams. I started my coding journey through
        LaunchCode's Web Development program, and it <em>completely changed my life</em> — now I get
      ...
      <p class="text-body1">
        ...
        <strong>women</strong> and <strong>queer folks</strong> who are breaking into tech. I've
        worked with LaunchCode as a teaching assistant and volunteer reviewer, helping students prep
        for interviews and polish their projects.
      </p>
      <p class="text-body1">
        I love experimenting with fun little side projects like
        <strong>StandUp.gif</strong>. It sparks joy to create apps that make me smile and
        (hopefully) <strong>make someone else's day a little brighter too.</strong>
        I'm currently learning more about mobile development and always chasing the next creative
        idea.
      </p>
      <p class="text-body1">
        When I'm not coding or mentoring, you can usually find me watching reality TV or keeping up
        with the current astrological transits (check out my other project,
        <a href="https://www.moonology.net" target="_blank" class="text-primary">Moonology</a>, for
        more on that). 🌙
      </p>
      <p class="text-body1">
